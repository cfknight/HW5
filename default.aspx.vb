...
Partial Class _Default
    ...
    Protected Sub btnCalcPmt_Click(sender As Object, e As EventArgs) Handles calculateBTN.Click
        ...
        loanAmount = CDbl(loanAmtTB.Text)
        annualRate = CDbl(interestTB.Text)
        term = CDbl(termTB.Text)

        'This section formats the loan input to currency.
        loanAmtTB.Text = FormatCurrency(loanAmount)
